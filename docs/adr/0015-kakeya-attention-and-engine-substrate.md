...
| **KIE-v1.1.z** | **throughput**: graph-captured + fused (Triton/CUDA) quantized-attention kernel + continuous-batched prefill — make the high-concurrency engine *fast* (the remaining axis) | planned | — |
