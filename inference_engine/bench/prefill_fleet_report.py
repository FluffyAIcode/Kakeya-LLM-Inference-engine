...
PHASES = (
    ...
    "agent_generator",
    "agent_critic",
    "agent_strategy_tournament_selector",
    "agent_strategy_critic_selector",
    "agent_synthesis",
    "agent_premise_suspicion",
    "agent_premise_auditor",
    "agent_premise_proponent",
    "agent_definition_auditor",
    "agent_counterexample_worker",
    "agent_decomposer",
    "agent_math_ir_translator",
    "agent_formalizer",
    "agent_proof_action_selector",
    "agent_prover",
